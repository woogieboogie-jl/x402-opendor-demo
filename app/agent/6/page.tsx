...
export default function VolumeRiderPage() {
  return (
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-start justify-between mb-4">
            <div>
              <h1 className="text-4xl font-bold mb-2">Volume Rider</h1>
              <div className="flex items-center gap-2 text-muted-foreground mb-3">
                <span>by 0x1a5c...7e3d</span>
                <Badge variant="outline" className="bg-accent/10 text-accent border-accent/20">
                  Public Agent
                </Badge>
              </div>
              <p className="text-muted-foreground max-w-2xl">
                Enters positions when unusual volume spikes occur across multiple timeframes
              </p>
            </div>
          ...
          <div className="grid gap-6 md:grid-cols-4 mb-8">
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-3xl font-bold">64.8%</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="pb-2">
              ...
              <CardContent>
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-3xl font-bold text-accent">+$9,872</p>
                </div>
              </CardContent>
            </Card>
            <Card>
          ...
          <div className="grid gap-6 md:grid-cols-2 mb-8">
            <Card>
              ...
              <CardContent>
                <p className="text-2xl font-bold">$750 USDC</p>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-2xl font-bold">16 users</p>
                <p className="text-sm text-muted-foreground mt-1">
