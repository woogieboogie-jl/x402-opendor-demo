...
export const allAgentsData: Record<string, AgentDetailData> = {
  '1': {
    ...
    transactions: [
      { id: '1', type: 'Creation', amount: 10, date: '2024-01-10 10:00', txHash: '0xaaaa...bbbb', chain: 'Solana' },
      { id: '2', type: 'Deposit', amount: 5000, date: '2024-01-10 10:15', txHash: '0xcccc...dddd', chain: 'Solana' },
      { id: '3', type: 'Trade', amount: 900, date: '2024-01-15 14:32', txHash: '0x9876...5432', chain: 'Solana' },
      { id: '4', type: 'Deposit', amount: 240, date: '2024-01-14 16:20', txHash: '0xeeee...ffff', chain: 'Solana' },
      { id: '5', type: 'Trade', amount: 1300, date: '2024-01-14 16:30', txHash: '0x2222...3333', chain: 'Solana' },
      { id: '6', type: 'Trade', amount: 365, date: '2024-01-13 20:15', txHash: '0x3333...4444', chain: 'Solana' },
      { id: '7', type: 'Trade', amount: 405, date: '2024-01-13 14:20', txHash: '0x4444...5555', chain: 'Solana' },
      { id: '8', type: 'Trade', amount: 480, date: '2024-01-12 18:45', txHash: '0x5555...6666', chain: 'Solana' },
      { id: '9', type: 'Trade', amount: 250, date: '2024-01-12 10:30', txHash: '0x6666...7777', chain: 'Solana' },
      { id: '10', type: 'Trade', amount: -300, date: '2024-01-11 22:00', txHash: '0x7777...8888', chain: 'Solana' },
      { id: '11', type: 'Deposit', amount: 500, date: '2024-01-11 18:00', txHash: '0xdddd...eeee', chain: 'Solana' },
      { id: '12', type: 'Trade', amount: 280, date: '2024-01-11 15:45', txHash: '0x8888...9999', chain: 'Solana' },
      { id: '13', type: 'Trade', amount: 480, date: '2024-01-10 19:20', txHash: '0x9999...aaaa', chain: 'Solana' },
      { id: '14', type: 'Trade', amount: 800, date: '2024-01-10 12:10', txHash: '0xaaaa...bbbb', chain: 'Solana' },
    ],
    reasoningLog: [
  ...
  '2': {
    id: '2',
    name: 'SOL Sentiment',
    strategy: 'Monitors Solana ecosystem sentiment from @rajgokal, @aeyakovenko, and community signals',
    funded: 2100,
    pnl: -342.18,
    winRate: 42.1,
    sharpeRatio: 1.2,
    ...
    positions: [
      { id: '1', asset: 'SOL/USD', type: 'Long', entry: 98.50, current: 95.20, pnl: -63, leverage: '2x', txHash: '5v2222...3333' },
      { id: '2', asset: 'JUP/USD', type: 'Long', entry: 0.85, current: 0.88, pnl: 40, leverage: '1x', txHash: '5v3333...4444' },
    ],
    completedTrades: [
      { id: '1', date: '2024-01-14 10:30', asset: 'SOL/USD', type: 'Long', entry: 101.50, exit: 98.50, pnl: -34, duration: '3h 45m', txHash: '5v3333...4444' },
      { id: '2', date: '2024-01-13 15:20', asset: 'JUP/USD', type: 'Long', entry: 0.82, exit: 0.87, pnl: 120, duration: '5h 10m', txHash: '5v4444...5555' },
      { id: '3', date: '2024-01-13 08:45', asset: 'SOL/USD', type: 'Long', entry: 95.00, exit: 99.50, pnl: 48, duration: '2h 30m', txHash: '5v5555...6666' },
      { id: '4', date: '2024-01-12 19:20', asset: 'BONK/USD', type: 'Short', entry: 0.000025, exit: 0.000022, pnl: 90, duration: '4h 15m', txHash: '5v6666...7777' },
      { id: '5', date: '2024-01-12 11:10', asset: 'SOL/USD', type: 'Long', entry: 97.00, exit: 94.50, pnl: -36, duration: '6h 20m', txHash: '5v7777...8888' },
      { id: '6', date: '2024-01-11 16:30', asset: 'JUP/USD', type: 'Long', entry: 0.78, exit: 0.83, pnl: 90, duration: '3h 45m', txHash: '5v8888...9999' },
      { id: '7', date: '2024-01-11 09:15', asset: 'SOL/USD', type: 'Short', entry: 102.00, exit: 99.50, pnl: 23, duration: '1h 50m', txHash: '5v9999...aaaa' },
      { id: '8', date: '2024-01-10 20:00', asset: 'BONK/USD', type: 'Long', entry: 0.000024, exit: 0.000022, pnl: -40, duration: '7h 30m', txHash: '5vaaaa...bbbb' },
      { id: '9', date: '2024-01-10 14:25', asset: 'SOL/USD', type: 'Long', entry: 93.00, exit: 97.50, pnl: 36, duration: '4h 10m', txHash: '5vbbbb...cccc' },
    ],
    transactions: [
      { id: '1', type: 'Creation', amount: 10, date: '2024-01-10 10:00', txHash: '5vaaaa...bbbb', chain: 'Solana' },
      { id: '2', type: 'Deposit', amount: 2100, date: '2024-01-10 10:20', txHash: '5vcccc...dddd', chain: 'Solana' },
      { id: '3', type: 'Trade', amount: -34, date: '2024-01-14 10:30', txHash: '5v3333...4444', chain: 'Solana' },
      { id: '4', type: 'Trade', amount: 120, date: '2024-01-13 15:20', txHash: '5v4444...5555', chain: 'Solana' },
      { id: '5', type: 'Trade', amount: 48, date: '2024-01-13 08:45', txHash: '5v5555...6666', chain: 'Solana' },
      { id: '6', type: 'Trade', amount: 90, date: '2024-01-12 19:20', txHash: '5v6666...7777', chain: 'Solana' },
      { id: '7', type: 'Trade', amount: -36, date: '2024-01-12 11:10', txHash: '5v7777...8888', chain: 'Solana' },
      { id: '8', type: 'Trade', amount: 90, date: '2024-01-11 16:30', txHash: '5v8888...9999', chain: 'Solana' },
      { id: '9', type: 'Trade', amount: 23, date: '2024-01-11 09:15', txHash: '5v9999...aaaa', chain: 'Solana' },
      { id: '10', type: 'Trade', amount: -40, date: '2024-01-10 20:00', txHash: '5vaaaa...bbbb', chain: 'Solana' },
      { id: '11', type: 'Trade', amount: 36, date: '2024-01-10 14:25', txHash: '5vbbbb...cccc', chain: 'Solana' },
    ],
    reasoningLog: [
      { id: '1', time: '2024-01-14 10:30', trigger: 'Social Signal', context: '@rajgokal posted about Solana mobile growth', action: 'Opened long position SOL 2x', reasoning: 'Positive sentiment from Solana co-founder on mobile adoption. Historical correlation: 45% price increase within 4 hours of major announcements' },
      { id: '2', time: '2024-01-13 15:20', trigger: 'Social Signal', context: '@aeyakovenko shared Jupiter DEX milestone', action: 'Opened long position JUP 1x', reasoning: 'Toly endorsement of Jupiter ecosystem growth. DEX tokens typically rally on ecosystem validation' },
      { id: '3', time: '2024-01-13 08:45', trigger: 'Social Signal', context: 'SOL trending on Crypto Twitter with 50k+ mentions', action: 'Opened long position SOL 2x', reasoning: 'Social volume spike detected. Sentiment analysis shows 78% positive mentions. Entry before mainstream attention' },
      { id: '4', time: '2024-01-12 19:20', trigger: 'Social Signal', context: 'BONK memecoin overheated sentiment detected', action: 'Opened short position BONK 1x', reasoning: 'Negative sentiment detected after parabolic run. Memecoins typically retrace 30-50% after peaks' },
      { id: '5', time: '2024-01-12 11:10', trigger: 'Social Signal', context: '@rajgokal mentioned at Solana conference', action: 'Opened long position SOL 2x', reasoning: 'Conference keynote buzz detected. Historical impact: average 5% price increase post-events' },
      { id: '6', time: '2024-01-11 16:30', trigger: 'Social Signal', context: 'Jupiter airdrop discussion trending', action: 'Opened long position JUP 1x', reasoning: 'Social media discussion about JUP utility. Pre-catalyst momentum typically bullish' },
      { id: '7', time: '2024-01-11 09:15', trigger: 'Social Signal', context: 'SOL overbought sentiment detected', action: 'Opened short position SOL 2x', reasoning: 'Social sentiment analysis shows overbought conditions. FOMO peak detected, expecting pullback' },
    ],
  ...
  '3': {
    ...
    completedTrades: [],
    transactions: [
      { id: '1', type: 'Creation', amount: 10, date: '2024-01-12 10:00', txHash: '0xaaaa...bbbb', chain: 'Solana' },
    ],
    reasoningLog: [],
    qualificationCriteria: {
  ...
  '4': {
    ...
    transactions: [
      { id: '1', type: 'Creation', amount: 10, date: '2024-10-10 10:00', txHash: '0xaaaa...bbbb', chain: 'Solana' },
      { id: '2', type: 'Deposit', amount: 5000, date: '2024-10-10 10:15', txHash: '0xcccc...dddd', chain: 'Solana' },
      { id: '3', type: 'Trade', amount: 182, date: '2024-11-03 11:20', txHash: '0x7777...8888', chain: 'Solana' },
      { id: '4', type: 'Trade', amount: 240, date: '2024-11-02 14:45', txHash: '0x8888...9999', chain: 'Solana' },
      { id: '5', type: 'Trade', amount: 133, date: '2024-11-02 08:30', txHash: '0x9999...aaaa', chain: 'Solana' },
      { id: '6', type: 'Trade', amount: 77, date: '2024-11-01 19:15', txHash: '0xaaaa...bbbb', chain: 'Solana' },
      { id: '7', type: 'Trade', amount: 143, date: '2024-11-01 12:00', txHash: '0xbbbb...cccc', chain: 'Solana' },
      { id: '8', type: 'Deposit', amount: 2000, date: '2024-10-31 20:00', txHash: '0xeeee...ffff', chain: 'Solana' },
      { id: '9', type: 'Trade', amount: 185, date: '2024-10-31 16:45', txHash: '0xcccc...dddd', chain: 'Solana' },
      { id: '10', type: 'Trade', amount: 49, date: '2024-10-31 09:20', txHash: '0xdddd...eeee', chain: 'Solana' },
      { id: '11', type: 'Trade', amount: 143, date: '2024-10-30 21:30', txHash: '0xeeee...ffff', chain: 'Solana' },
      { id: '12', type: 'Trade', amount: 38, date: '2024-10-30 14:10', txHash: '0xffff...0000', chain: 'Solana' },
      { id: '13', type: 'Trade', amount: 119, date: '2024-10-29 18:00', txHash: '0x0000...1111', chain: 'Solana' },
      { id: '14', type: 'Trade', amount: 150, date: '2024-10-29 10:45', txHash: '0x1111...2222', chain: 'Solana' },
      { id: '15', type: 'Trade', amount: 83, date: '2024-10-28 15:20', txHash: '0x2222...3333', chain: 'Solana' },
    ],
    reasoningLog: [
  ...
  '5': {
    ...
    transactions: [
      { id: '1', type: 'Creation', amount: 10, date: '2024-10-10 10:00', txHash: '0xaaaa...bbbb', chain: 'Solana' },
      { id: '2', type: 'Deposit', amount: 3000, date: '2024-10-10 10:15', txHash: '0xcccc...dddd', chain: 'Solana' },
      { id: '3', type: 'Trade', amount: 400, date: '2024-11-02 09:30', txHash: '0xaaaa...bbbb', chain: 'Solana' },
      { id: '4', type: 'Trade', amount: 200, date: '2024-11-01 16:15', txHash: '0xbbbb...cccc', chain: 'Solana' },
      { id: '5', type: 'Trade', amount: 800, date: '2024-11-01 08:20', txHash: '0xcccc...dddd', chain: 'Solana' },
      { id: '6', type: 'Trade', amount: 420, date: '2024-10-31 19:45', txHash: '0xdddd...eeee', chain: 'Solana' },
      { id: '7', type: 'Trade', amount: 280, date: '2024-10-31 11:10', txHash: '0xeeee...ffff', chain: 'Solana' },
      { id: '8', type: 'Deposit', amount: 1500, date: '2024-10-30 20:00', txHash: '0xffff...0000', chain: 'Solana' },
      { id: '9', type: 'Trade', amount: 700, date: '2024-10-30 15:30', txHash: '0xffff...0000', chain: 'Solana' },
      { id: '10', type: 'Trade', amount: 490, date: '2024-10-30 07:00', txHash: '0x0000...1111', chain: 'Solana' },
      { id: '11', type: 'Trade', amount: 240, date: '2024-10-29 18:20', txHash: '0x1111...2222', chain: 'Solana' },
      { id: '12', type: 'Trade', amount: 700, date: '2024-10-29 10:45', txHash: '0x2222...3333', chain: 'Solana' },
      { id: '13', type: 'Trade', amount: 360, date: '2024-10-28 22:00', txHash: '0x3333...4444', chain: 'Solana' },
      { id: '14', type: 'Trade', amount: 320, date: '2024-10-28 14:15', txHash: '0x4444...5555', chain: 'Solana' },
    ],
    reasoningLog: [
  ...
  '6': {
    ...
    transactions: [
      { id: '1', type: 'Creation', amount: 10, date: '2024-10-10 10:00', txHash: '0xaaaa...bbbb', chain: 'Solana' },
      { id: '2', type: 'Deposit', amount: 4000, date: '2024-10-10 10:15', txHash: '0xcccc...dddd', chain: 'Solana' },
      { id: '3', type: 'Trade', amount: 235, date: '2024-11-03 08:00', txHash: '0xeeee...ffff', chain: 'Solana' },
      { id: '4', type: 'Trade', amount: 160, date: '2024-11-02 12:20', txHash: '0xffff...0000', chain: 'Solana' },
      { id: '5', type: 'Trade', amount: 270, date: '2024-11-02 05:15', txHash: '0x0000...1111', chain: 'Solana' },
      { id: '6', type: 'Trade', amount: 280, date: '2024-11-01 20:30', txHash: '0x1111...2222', chain: 'Solana' },
      { id: '7', type: 'Trade', amount: 170, date: '2024-11-01 13:45', txHash: '0x2222...3333', chain: 'Solana' },
      { id: '8', type: 'Deposit', amount: 2500, date: '2024-10-31 21:00', txHash: '0x3333...4444', chain: 'Solana' },
      { id: '9', type: 'Trade', amount: 360, date: '2024-10-31 17:00', txHash: '0x3333...4444', chain: 'Solana' },
      { id: '10', type: 'Trade', amount: 230, date: '2024-10-31 09:20', txHash: '0x4444...5555', chain: 'Solana' },
      { id: '11', type: 'Trade', amount: 320, date: '2024-10-30 22:15', txHash: '0x5555...6666', chain: 'Solana' },
      { id: '12', type: 'Trade', amount: 241, date: '2024-10-30 14:40', txHash: '0x6666...7777', chain: 'Solana' },
      { id: '13', type: 'Trade', amount: 250, date: '2024-10-29 19:30', txHash: '0x7777...8888', chain: 'Solana' },
      { id: '14', type: 'Trade', amount: 270, date: '2024-10-29 11:00', txHash: '0x8888...9999', chain: 'Solana' },
      { id: '15', type: 'Trade', amount: 320, date: '2024-10-28 16:45', txHash: '0x9999...aaaa', chain: 'Solana' },
    ],
    reasoningLog: [
